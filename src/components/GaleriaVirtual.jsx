...
import {getExpos} from '../helpers/getExpos'

const GaleriaVirtual = () => {
  ...
  return (
    ...
    <div className='text-center uppercase text-lg text-[#5B3427]'>
        ...
        <div class="relative h-screen overflow-hidden rounded-lg">
            ...
            {
            cartes.map(ele => (
                <div class="hidden duration-1000 ease-in-out" data-carousel-item key={ele.id}>
